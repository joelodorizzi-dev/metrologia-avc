...
import { Search, Plus, Filter, MoreVertical, Calendar, Upload, Loader2, AlertTriangle, RefreshCcw, Bell, Mail, AlertCircle, CheckCircle2, Download, Trash2 } from 'lucide-react';
    ...
    <div className="p-6 h-full flex flex-col bg-slate-50">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">Gestão de Calibração e Manutenção de Equipamentos.</p>
        </div>
